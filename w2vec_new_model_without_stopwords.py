...
def Output_string(cls,clf):
	return 'C:\\Users\\Fernando\\Desktop\\DEEP LEARNING 2\\Resultados\\New Embeddings (shortwords stopwords)\\'+clf+'\\'+cls+'_'+'new_model'+'.txt'

def Classify(cls,clf):

	#Start moment 
	Start_moment=time.time()
	title='Classifying '+cls+' using W2Vec '+ 'using new model (trained without shortwords) without stopwords'
	print(title)
