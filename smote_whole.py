...
def Output_string(cls,vec,clf):
	return 'C:\\Users\\Fernando\\Desktop\\DEEP LEARNING 2\\Resultados\\SMOTE_Regular\\'+clf+'\\'+vec+'\\'+cls+'_'+vec+'-'+clf+'.txt'

def Classify(cls,vec,clf):

	# Creating vectorizer 
	print('Running '+cls+' on '+vec+'-'+clf)
	...
	title='Classifying '+cls+' using '+vec+'-'+clf+' with smote '
